...
<head>      
    ...
    <style>      
        ...
        .logo {      
            ...
            margin-bottom: 20px; /* Ruang di bawah logo */      
            display: block; /* Memastikan logo berada di baris baru */      
...
<body>      
    <div class="container d-flex justify-content-center align-items-center vh-100">      
        <div class="card w-50">      
            <img src="<?php echo base_url('assets/images/logo.png'); ?>" alt="Logo Saka Bhayangkara" class="logo">    
            <h3 class="text-center mb-4">Selamat Datang di Aplikasi Pengarsipan Digital Saka Bhayangkara</h3>      
