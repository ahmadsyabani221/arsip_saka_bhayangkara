...
<body>
    ...
    <div class="content" id="content">
        <div class="container mt-5">
            <h1 class="text-center mb-4">Edit Arsip</h1>

            <form action="<?php echo site_url('arsip/update/' . $arsip->id); ?>" method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5>Edit Informasi Arsip</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama_arsip">Nama Arsip</label>
                            <input type="text" name="nama_arsip" value="<?php echo $arsip->nama_arsip; ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="kategori" class="form-control" required>
                                ...
                                <?php foreach ($kategori as $row) : ?>
                                    <option value="<?php echo $row->nama; ?>" <?php echo ($arsip->kategori == $row->nama) ? 'selected' : ''; ?>><?php echo $row->nama; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="new_file">File Baru</label>
