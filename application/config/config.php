...
|
*/
$config['base_url'] = 'http://localhost/saka_bhayangkara/';
...
|
*/
$config['encryption_key'] = 'easygoing';
...
$config['email_smtp_user']   = 'your-email@gmail.com'; // Ganti dengan email Anda
$config['email_smtp_pass']   = 'your-password';       // Ganti dengan password email Anda
